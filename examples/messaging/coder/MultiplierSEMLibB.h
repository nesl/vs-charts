...
#ifndef __MultiplierSEMLIBB_H
#define __MultiplierSEMLIBB_H
 ...
 * Portability :    ANSI-C Compiler.
 */
#define MultiplierSEM_Action(ActionNo) ((*MultiplierVSAction[(ActionNo)])())
 ...
 * Portability :    ANSI-C Compiler.
 */
#define MultiplierSEM_TableAction(Table, ActionNo) ((*((Table))[(ActionNo)])())
